@javascript @block @block_pimenkofeaturedcourses-Permissions
Feature: Pimenko Featured Courses block functionality
  ...
  Scenario: Vérifie que les étudiant tombe bien sur la page d'inscription s'il n'est pas encore inscrit.

    When I log in as "student2"
    And I am on site homepage
    And I click on ".card-deck .card:nth-child(2) .course_title a" "css_element"
    Then I should see "Enrolment options" in the "#page-enrol-index #page #region-main-box #region-main div[role='main'] h2" "css_element"
